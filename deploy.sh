...
kubectl set image deployments/client-deployment server=mbcatubig14/multi-client-10-14:$SHA
kubectl set image deployments/worker-deployment server=mbcatubig14/multi-worker-10-14:$SHA
